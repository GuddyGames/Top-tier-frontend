            ...
            {referrals.map((ref) => (
              <div key={ref.id} className="rounded-lg border border-border bg-surface px-4 py-3">
                ...
                <div className="mt-1 text-xs text-ink-muted">
                  {ref.email}
                  {ref.telegram_username
                    ? ` · @${ref.telegram_username.replace(/^@/, '')}`
                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  ...
                  {task.link && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="rounded-lg border border-gold px-3 py-2 text-xs font-semibold text-gold"
                    >
                      Open task
                    </a>
                  )}
